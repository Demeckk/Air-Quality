<?php 
	...
	class Tini{
		...
		function __construct($name){
			...
			//	"PROJECT_DESCRIPTION" => getenv('PROJECT_DESCRIPTION'),
			//	"PROJECT_AUTHOR" => getenv('PROJECT_AUTHOR'),
			//	"PROJECT_AUTHOR_CONTACT" => getenv('PROJECT_AUTHOR_CONTACT'),
			//	"PROJECT_URL" => getenv('PROJECT_URL'),
			//	"PROJECT_KEYWORDS" => getenv('PROJECT_KEYWORDS'),
			//	"PROJECT_MODE" => getenv('PROJECT_MODE'),
			//];
